Config = {
	...
	Strings = {
		...
		Banned = "You're Banned, Appeal At https://nexodusrp.net/\n\nReason: %s\nExpires: %s\nID: %s",
		PermaBanned = "Permanently Banned, Appeal At https://nexodusrp.net/\n\nReason: %s\nID: %s",
		SiteBanned = "You're Banned From the Website. View Reason At https://nexodusrp.net/",
		...
		IdentifierNotLinked = "Identifier Not Linked To Any Blue Sky Account, Please Go To https://nexodusrp.net/ & Link Your Account.",
		...
		NotWhitelisted = "You Are Not Whitelisted For This Server - Apply Today At https://nexodusrp.net/",
		...
		PublicWhitelist = "You need to register an account at https:/nexodusrp.net/ and link your Steam account to play on this server.",
	},
	Emotes = {
		"🍕",
		"🍔",
